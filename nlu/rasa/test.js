...
TrainBot.prototype = {
    train: function () {
        var child_process = require('child_process').execSync('python -m rasa_nlu.train -c HRbot/config.yml --data HRbot/HR_Bot.json -o models/');
        //child_process.stdout.pipe(process.stdout);
        //child_process.on('exit', function () {
        //    // process.exit();
        //    console.log('training finshed.');
        //});
        console.log('training finshed.');
    }
};
